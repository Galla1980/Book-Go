...
namespace DAL_327LG
{
    public class DALBackUpRestore_327LG
    {
        private string connectionString = "Data Source=.;Initial Catalog=SistemaBiblioteca;Integrated Security=True;Trust Server Certificate=True";
